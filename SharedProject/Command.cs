...
namespace SharedProject
{
    public static class Command
    {
        ...
        public static System.Diagnostics.Process Execute(string filename, string arguments, string working_directory = "")
        {
            ...
            return System.Diagnostics.Process.Start(_processStartInfo);
        }
